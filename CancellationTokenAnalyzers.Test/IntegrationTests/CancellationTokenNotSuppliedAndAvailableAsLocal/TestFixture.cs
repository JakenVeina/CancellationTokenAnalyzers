...
namespace CancellationTokenAnalyzers.Test.IntegrationTests.CancellationTokenNotSuppliedAndAvailableAsLocal
{
    [TestFixture]
        ...
        : CancellationTokenUsageIntegrationTestFixtureBase
    {
        ...
        protected sealed override ImmutableArray<DiagnosticOutcome> ExpectedDiagnostics { get; }
            = ImmutableArray.Create(
                new DiagnosticOutcome(  CancellationTokenAvailableButNotSuppliedDiagnostic.Descriptor.Id,   "FakeFolder/FakeDocument1.cs",  24, 19));
