...
namespace CancellationTokenAnalyzers.Test.IntegrationTests.ExternalCancellableOverloadAvailable
{
    [TestFixture]
        ...
        : CancellationTokenUsageIntegrationTestFixtureBase
    {
        ...
        protected sealed override ImmutableArray<DiagnosticOutcome> ExpectedDiagnostics { get; }
            = ImmutableArray.Create(
                new DiagnosticOutcome(  CancellationTokenAvailableButNotSuppliedDiagnostic.Descriptor.Id,   "FakeFolder/FakeDocument1.cs",  17, 19));
