...
namespace CancellationTokenAnalyzers.Test.IntegrationTests.ManyCancellableOverloadsAvailable
{
    [TestFixture]
        ...
        : CancellationTokenUsageIntegrationTestFixtureBase
    {
        ...
        protected sealed override ImmutableArray<DiagnosticOutcome> ExpectedDiagnostics { get; }
            = ImmutableArray.Create(
                new DiagnosticOutcome(  CancellationTokenAvailableButNotSuppliedDiagnostic.Descriptor.Id,   "FakeFolder/FakeDocument1.cs",  32, 19),
                new DiagnosticOutcome(  CancellationTokenAvailableButNotSuppliedDiagnostic.Descriptor.Id,   "FakeFolder/FakeDocument1.cs",  41, 19));
